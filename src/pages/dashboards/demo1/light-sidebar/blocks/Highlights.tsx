...
const Highlights = ({ limit }: IHighlightsProps) => {
  const rows: IHighlightsRows = [
    { icon: 'whatsapp', text: 'Whatsapp', total: 172, stats: 3.9, increase: true },
    { icon: 'shop', text: 'Online URL', total: 85, stats: 0.7, increase: false },
    { icon: 'facebook', text: 'Facebook', total: 36, stats: 8.2, increase: true },
    { icon: 'instagram', text: 'Instagram', total: 26, stats: 8.2, increase: true },
  ];

  const items: IHighlightsItems = [
    { badgeColor: 'badge-success', lebel: 'Credit Cards' },
    { badgeColor: 'badge-danger', lebel: 'Valu' },
    { badgeColor: 'badge-info', lebel: 'Mobile Wallet' }
  ];
    ...
    return (
      <div key={index} className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center text-sm font-medium text-gray-800 gap-6">
          <span className="lg:text-right">{row.total}k EGP</span>
      ...
      <div className="card-body flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
        <div className="flex flex-col gap-0.5">
          ...
          <div className="flex items-center gap-2.5">
            <span className="text-3xl font-semibold text-gray-900">295.7k EGP</span>
