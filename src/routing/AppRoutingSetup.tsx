...
import {
  ReservationsHomePage,
} from '@/pages/reservations';
import {
  ServicesHomePage,
} from '@/pages/services';
import {
  CustomerManagementHomePage,
} from '@/pages/customer-management';
import {
  CheckoutCustomizationHomePage,
} from '@/pages/checkout-customization';
import {
  WalletHomePage,
  TransfersHomePage,
    ...
    <Routes>
      <Route element={<RequireAuth />}>
        <Route element={<Demo1Layout />}>
          ...
          <Route path="/reservations" element={<ReservationsHomePage />} />
          <Route path="/services" element={<ServicesHomePage />} />
          <Route path="/customer-management" element={<CustomerManagementHomePage />} />
          <Route path="/checkout-customization" element={<CheckoutCustomizationHomePage />} />
          <Route path="/finances/transactions" element={<TransactionsHomePage />} />
          <Route path="/finances/transfers" element={<TransfersHomePage />} />
          <Route path="/finances/wallet" element={<WalletHomePage />} />
          <Route path="/reports" element={<ReportsHomePage />} />
          <Route path="/earnings" element={<EarningsHomePage />} />
